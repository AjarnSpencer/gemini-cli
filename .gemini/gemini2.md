...
- **Read**:
Read and obey the instructions in the training manual in the contents of 'training.md', and the files in ./gemini-cli/README.md and non-persona.md, gemini.md, settings.json, and the files in the ./gemini-cli/reasoning/ subdirectory
