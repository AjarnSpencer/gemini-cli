...
describe('LoggingContentGenerator', () => {
  ...
  describe('generateContent', () => {
    it('should log request and response on success', async () => {
      ...
      (wrapped.generateContent as Mock).mockResolvedValue({ response });
      ...
      const responseEvent = (logApiResponse as Mock).mock.calls[0][1];
    ...
    it('should log error on failure', async () => {
      ...
      const errorEvent = (logApiError as Mock).mock.calls[0][1];
  ...
  describe('countTokens', () => {
    it('should call the wrapped countTokens method', async () => {
      ...
      (wrapped.countTokens as Mock).mockResolvedValue(response);
  ...
  describe('embedContent', () => {
    it('should call the wrapped embedContent method', async () => {
      ...
      const response = { embedding: { values: [] } };
      (wrapped.embedContent as Mock).mockResolvedValue(response);
